...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.hazardLava1, function (sprite, location) {
    game.gameOver(false)
    game.setGameOverMessage(false, "DON't fall in the LEVA")
})
...
game.onUpdate(function () {
    mySprite.setImage(img`
        d d d d . . . . . . . . . . . . 
        d d d d . 1 1 1 1 1 . . . . . . 
        d d d d 1 4 4 4 4 4 1 1 . . . . 
        d d d d 4 4 4 4 4 4 4 1 . . . . 
        d d d d 1 7 7 7 7 7 1 . . . . . 
        d d d d 1 5 5 d 5 5 1 . . . . . 
        d d d d 1 2 2 2 2 2 1 . . . . . 
        d d d d 4 4 4 4 4 4 . . . . . . 
        d d d d d d d d d . . . . . . . 
        d d d d d d d d f . . . . . . . 
        d d d d d d d d d . . . 1 . . . 
...
game.onUpdateInterval(randint(3000, 7000), function () {
    Z = sprites.create(img`
        ...
        .............fffff..............
        `, SpriteKind.Enemy)
    Z.setPosition(scene.screenWidth(), randint(0, scene.screenHeight()))
    Z.setVelocity(-2, 0)
    Z.follow(mySprite)
})
